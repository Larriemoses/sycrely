...
type Message = { id: string; role: "user" | "assistant"; text: string; protectedText?: string; capsule?: TaskCapsule };
...
function ReviewModal({ request, onCancel, onSend }: { request: PendingRequest; onCancel: () => void; onSend: () => void }) {

...
export const PRIVACY_CORPUS: PrivacyCase[] = [
  ...
  { id:"executive-pay-complaint",input:"There is a behaviour my CEO mr. Olaniyi who owns Greyish Chamber is showing towards us the employees. He doesn't pay us our salaries on time. The company which is located in Ikorodu, Lagos is not practicing the best work ethic.",expectedCategories:["identity","organization","location","employment"],mustHide:["Olaniyi","Greyish Chamber","Ikorodu","Lagos"],mustKeep:["salaries on time","work ethic"] },

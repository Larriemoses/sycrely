...
export const CONTEXT_RULES: ContextRule[] = [
  ...
  { id:"education",label:"Education record or student context",severity:"moderate",handling:"preserve",pattern:/\b((?:I am|I'm|as a) (?:university |college |secondary-school )?student|a student (?:of|at)|enrolled|stud(?:y|ies|ied)|school record|exam|revision plan|academic record|disciplinary (?:record|warning)|scholarship|plagiarism|GPA|carryovers?|research method)\b/i },
